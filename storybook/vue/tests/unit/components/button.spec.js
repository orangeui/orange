...
describe("Button tests", () => {
  ...
  it('renders button roles', () => {
    ...
    expect(button_primary.classes()).toContain('button--primary');
    ...
    expect(button_secondary.classes()).toContain('button--secondary');
    ...
    expect(button_basic.classes()).toContain('button--basic');
  });
  ...
  it('renders button sizes', () => {
    ...
    expect(button_large.classes()).toContain('button--large');
    ...
    expect(button_regular.classes('button')).toBe(true)
    ...
    expect(button_small.classes()).toContain('button--small');
  });
  ...
  it('renders wide button', () => {
    ...
    expect(button_wide.classes()).toContain('button--wide');
  });
  ...
  it('renders buttons with icon', () => {
    ...
    expect(button_icon_only.find('.icon-remove').exists()).toBe(true);
    expect(button_icon_only.classes()).toContain('button--icon-only');
    ...
    expect(button_icon_text.find('.icon-arrow-right').exists()).toBe(true);
    expect(button_icon_text.text()).toBe('With an icon');
    expect(button_icon_text.classes('button--icon-only')).toBe(false);
  });
  ...
  it('renders button colors', () => {
    ...
    expect(button_red.classes()).toContain('button--color-red');
    ...
    expect(button_secondary.classes()).toContain('button--color-secondary');
  });
  ...
  it('renders inverted button', () => {
    ...
    expect(button_inverted.classes()).toContain('button--inverted');
  });  
});