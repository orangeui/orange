...
<Story name='Tryout'>
  {{
    ...
    template: `<o-message :heading="heading" :color="color">
      ...
      <o-button slot="action" text="action" size="small" v-if="action" @click="handleClick"></o-button>
    </o-message>`,
    ...
    {{
      ...
      template: `<div>
        <o-message heading="Heading">
          ...
          <o-button slot="action" text="action" size="small" @click="handleClick"></o-button>
        </o-message>
        <hr />
